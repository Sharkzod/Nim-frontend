...
const SettingsPage: React.FC = () => {
  ...
  const tabs = [
    { id: 'profile' as SettingsTab, label: 'Profile', icon: '/personal.png' },
  ...
  const handleTabClick = (tab: SettingsTab) => {
    router.push(`/dropshipper/settings/${tab}`);
  };

  const handleLogout = () => {
    // Simple logout logic - just redirect to login page
    // You can add your own logout implementation here
    router.push('/login');
  };
